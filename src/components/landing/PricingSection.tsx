...
const pricingPlans = [
  {
    ...
    creditOptions: [
      { credits: 3, price: 8.90 },
      { credits: 10, price: 19.90 },
      { credits: 20, price: 39 },
      { credits: 50, price: 95 },
      { credits: 100, price: 179 },
      { credits: 200, price: 330 },
      { credits: 500, price: 750 },
      { credits: 1000, price: 1390 },
      { credits: 2000, price: 2590 },
      { credits: 5000, price: 5900 },
    ],
    buttonText: "Acheter",
    features: [],
    popular: false,
  ...
  },
  {
    ...
    isMonthly: true,
    creditOptions: [
      { credits: 1000, price: 990 },
      { credits: 2000, price: 1790 },
      { credits: 5000, price: 3990 },
      { credits: 10000, price: 6900 },
      { credits: 25000, price: 14900 },
      { credits: 50000, price: 24900 },
      { credits: 100000, price: 39000 },
    ],
    buttonText: "Commencer",
    features: [
