    ...
    <div className="max-w-6xl mx-auto">
      ...
      {filteredProjects.length > 0 ? (
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Aucune réalisation</h3>
          <p className="text-gray-500 mb-6">Commencez à créer des miniatures avec Alice pour les retrouver ici</p>
          <Link
